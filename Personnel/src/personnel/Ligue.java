...
public class Ligue implements Serializable, Comparable<Ligue>
{
	...
	public void setAdministrateur(Employe administrateur) throws SauvegardeImpossible
	{
		...
		gestionPersonnel.updateAdministrateur(this);
	}
	...
	public Employe addEmploye(GestionPersonnel gestionPersonnel, int id, String nom, String prenom,
	        String mail, String password, LocalDate dateArrivee, LocalDate dateDepart)
	        throws DatesIncoherentesException
	{
	    Employe employe = new Employe(gestionPersonnel, this, id, nom, prenom,
